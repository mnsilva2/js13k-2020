...
gulp.task('build', gulp.series('build_source', 'build_index', 'build_styles'));
...
gulp.task('serve', gulp.series('build', 'start_serve'));
...
gulp.task('dist', gulp.series('build', 'dist_build'));
